...
struct EngineConfig {
    ...
    EngineConfig() : 
        ...
        //1 Chunk ≈ 39 KB.
        voxelPool(Items_K(1), Items_K(10), Items_K(60)), //start with enough memory for 1 million voxels, grow by 16 thousand if more is needed, never go beyond enough for 4 million voxels
