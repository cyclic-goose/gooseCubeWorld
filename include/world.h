...
public:
    ...
    World(EngineConfig config, std::unique_ptr<ITerrainGenerator> generator) : m_config(config), m_generator(std::move(generator)) {
        ...
        m_voxelPool.Init((int)(maxChunks)); // HOW MANY BYTES TO ALLOC FOR voxel pool
        // VRAM ALLOCATION // 
